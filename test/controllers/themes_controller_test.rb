...
class ThemesControllerTest < ActionController::TestCase
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post :create, theme: { back_ground: @theme.back_ground, name: @theme.name, text_color: @theme.text_color }
    end
  ...
  test "should update theme" do
    patch :update, id: @theme, theme: { back_ground: @theme.back_ground, name: @theme.name, text_color: @theme.text_color }
    assert_redirected_to theme_path(assigns(:theme))
  end
